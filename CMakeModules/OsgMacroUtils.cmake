...
MACRO(SETUP_APPLICATION APPLICATION_NAME)
        ...
        IF(APPLE)
            INSTALL(TARGETS ${TARGET_TARGETNAME} EXPORT OpenSceneGraph RUNTIME DESTINATION bin BUNDLE DESTINATION bin)
        ELSE(APPLE)
            INSTALL(TARGETS ${TARGET_TARGETNAME} EXPORT OpenSceneGraph RUNTIME DESTINATION bin COMPONENT openscenegraph  )
            IF(MSVC)
...
MACRO(SETUP_EXAMPLE EXAMPLE_NAME)
        ...
        IF(APPLE)
            INSTALL(TARGETS ${TARGET_TARGETNAME} EXPORT OpenSceneGraph RUNTIME DESTINATION share/OpenSceneGraph/bin BUNDLE DESTINATION share/OpenSceneGraph/bin )
        ELSE(APPLE)
            INSTALL(TARGETS ${TARGET_TARGETNAME} EXPORT OpenSceneGraph RUNTIME DESTINATION share/OpenSceneGraph/bin COMPONENT openscenegraph-examples )
            IF(MSVC)
